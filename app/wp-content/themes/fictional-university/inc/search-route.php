...
add_action('rest_api_init', 'universityCustomRoute');

function universityCustomRoute() {
    // we can access this route by: .../wp-json/university/v1/search?term=yoursearchterm
...
/* 
Search if the programs that showed in the results have some professors related to it?
*/
    if ($results['programs']) {
        ...
        // to remove duplicates in the inner arrays + remove non sense parent value of the array
