...
?>
    ...
    <div class="container container--narrow page-section">
        <div class="create-note">
            <h2 class="healine headline--medium">Create New Note</h2>
            <input class="new-note-title" type="text" placeholder="Title">
            <textarea class="new-note-body" placeholder="My note here.."></textarea>
            <span class="submit-note">Create Note</span><span class="limit-note"></span>
        </div>

        <ul class="min-list link-list" id="my-notes">
            <?php
            $currentUserNotes = new WP_Query(array(
                'post_type'     => 'note',
                'posts_per_page'    => -1,
                'author'            => get_current_user_id()
            ));

            while ($currentUserNotes->have_posts()) : $currentUserNotes->the_post(); ?>
